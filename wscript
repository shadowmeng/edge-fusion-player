...
def check_ffmpeg_or_libav_versions():
    print("call check_ffmpeg")
    def fn(ctx, dependency_identifier, **kw):
        print ("enter check_ffmpeg")
        versions = ffmpeg_pkg_config_checks
        print ("call check libav")
...
video_output_features = [
    {
        ...
        'func': check_statement(['EGL/egl.h'],
                                ...
                                lib=['EGL', 'GLESv2', 'dxguid', 'd3d9', 'd3dx10', 'd3dcompiler',
                                     'gdi32', 'stdc++'])
    }, {
        ...
        'desc': 'Direct3D support',
        'deps': 'win32-desktop && gpl',
        'func': check_cc(header_name='d3d9.h', lib=['-ld3dx10']),
    }, {
        'name': '--shaderc',
