...
def build(ctx):
    ...
    sources = [
		...
		( "video/out/vo_multidirect3d.c"),
		( "video/out/multid3d/YZDirector3DAdapter.cpp"),
		( "video/out/multid3d/YZDisplayOutput.cpp"),
		( "video/out/multid3d/YZWinDisplayOutput.cpp"),
		( "video/out/multid3d/multid3d_api.cpp"),
    ...
    if ctx.dependency_satisfied('cplayer') or ctx.dependency_satisfied('test'):
        ...
        objctx.env.CXXFLAGS = ['-DUSE_D3D9_MATH']
